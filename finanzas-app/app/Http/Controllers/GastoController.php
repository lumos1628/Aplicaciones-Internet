...
class GastoController extends Controller
{
    ...
    {
        $request->validate([
            'consumidorId' => 'required|exists:consumidores,id',
        ...
        Gasto::create($request->only('consumidorId', 'monto', 'fecha', 'categoria', 'descripcion'));
    ...
    public function update(Request $request, Gasto $gasto)
    {
        ...
        $gasto->update($request->only('consumidorId', 'monto', 'fecha', 'categoria', 'descripcion'));
